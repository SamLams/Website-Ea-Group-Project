"""all relationship table

Revision ID: 30f7787877a7
Revises: 
Create Date: 2020-04-23 04:45:59.669352
...
def upgrade():
    ...
    sa.Column('name', sa.String(length=120), nullable=True),
    sa.Column('link', sa.String(length=120), nullable=True),
    sa.Column('roduct_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['roduct_id'], ['product.pid'], ),
    sa.PrimaryKeyConstraint('id')
    )
